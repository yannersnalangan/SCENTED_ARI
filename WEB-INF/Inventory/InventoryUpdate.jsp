                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12 text-left mb-3">
                                <form method="POST" action="${pageContext.request.contextPath}/product/update" id="productForm" onsubmit="return formValidation()">
                                    <div class="mb-1 row">
                                    ...
                                    <div class="mb-1 row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control form-control-sm" id="productDescription" 
                                                       name="productDescription"><c:out value='${productDetails.productDescription}'/></textarea>
                                        </div>
                                    </div>
                                    <div class="mb-1 row">
                                        <label for="size" class="col-sm-3 col-form-label">Size</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control form-control-sm" id="size"
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary" style="background-color: #dc3545; border-color: #dc3545;">Save</button>
                                </form>
                            </div>
                        </div>
                    </div>
