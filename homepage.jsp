<%-- 
    Document   : homepage
    Created on : 6 Jul 2024, 4:03:13 pm
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link" href="${pageContext.request.contextPath}/homepage">Home
              ...
              <!-- User Icon -->
               <li class="nav-item">
                <a class="nav-link" href="${pageContext.request.contextPath}/index" >Log out</a>
              </li>
            </ul>
          </div>
        </div>
